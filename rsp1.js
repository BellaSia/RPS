const game = () => {
    ...
    const playMatch = () => {
      ...
      options.forEach(option => {
        option.addEventListener("click", function() {
          ...
          const computer_Choice = computerOptions[computerNumber];
          ...
          setTimeout(() => {
            ...
            computerHand.src = `./Img/${computer_Choice}.png`;
          }, 2000);
          //Animation
    ...
    const compareHands = (player_Choice, computer_Choice) => {
      ...
      player_final_score = document.getElementById("player_score").textContent;
      computer_final_score = document.getElementById("computer_score").textContent;
